...
import {CommentListWrapper, CommentReplyWrapper, CommentWrapper} from "./style";
...
const Comments = (props) => {
    ...
    const commentReplyHandler = (comment) => {
    ...
    return (
        <div>
            <CommentReplyWrapper />
            <div className={commentParent.id ? 'comment-reply-wrapper' : ''}>
                <CommentWrapper>
                    <label htmlFor="author">
                        <span>昵称</span>
                        <input onChange={inputChange} id="author" name="author" type="text"/>
                    </label>
                    <label htmlFor="authorUrl">
                        <span>主页</span>
                        <input onChange={inputChange} id="authorUrl" name="authorUrl" type="text"/>
                    </label>
                    <label htmlFor="email">
                        <span>邮箱</span>
                        <input onChange={inputChange} id="email" name="email" type="text"/>
                    </label>

                    <span>评论内容</span>
                    <textarea name="content" onChange={inputChange} id="content"/>
                    <div className="comment-btns">
                        <label htmlFor="allowNotification" id="allowNotification-label">
                            {formData.allowNotification}
                            <span style={{cursor: 'pointer'}} className={formData.allowNotification ? 'span-active' : ''}>邮件通知我</span>
                            <input onChange={checkBoxChange} id="allowNotification" name="allowNotification"
                                   type="checkbox"/>
                        </label>
                        <button id="submit" checked={checked} onClick={submit}>
                            {
                                isLoading ? (
                        ...
                        {
                            commentParent.id && <span style={{cursor: 'pointer'}} onClick={() => commentReplyHandler({})}>取消回复</span>
                        }
                    </div>
                </CommentWrapper>
            </div>
